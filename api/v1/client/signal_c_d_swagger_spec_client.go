...
const (
	...
	DefaultHost string = "localhost:6660"
...
// NewHTTPClient creates a new signal c d swagger spec HTTP client.
func NewHTTPClient(formats strfmt.Registry) *SignalCDSwaggerSpec {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new signal c d swagger spec HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *SignalCDSwaggerSpec {
...
// New creates a new signal c d swagger spec client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *SignalCDSwaggerSpec {
	// ensure nullable parameters have default
	if formats == nil {
